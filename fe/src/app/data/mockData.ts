...
export const TASKS: Task[] = [
  { id: "mock-task-1", title: "Hoàn thành báo cáo tuần", categoryId: "mock-1", dueDate: "14 Th3", priority: "Cao", completed: false, color: "indigo", description: "Tổng hợp kết quả công việc tuần này", eisenhowerMatrix: "urgent-important", context: ["Tại máy tính"], estimatedTime: 120 },
  { id: "mock-task-2", title: "Cập nhật portfolio", categoryId: "mock-2", dueDate: "18 Th3", priority: "Trung bình", completed: false, color: "blue", description: "Thêm 3 dự án mới vào portfolio", eisenhowerMatrix: "not-urgent-important", context: ["Tại máy tính", "Tập trung sâu"], estimatedTime: 180 },
  { id: "mock-task-3", title: "Đặt lịch khám răng", categoryId: "mock-3", dueDate: "15 Th3", priority: "Cao", completed: false, color: "emerald", description: "Khám định kỳ 6 tháng", eisenhowerMatrix: "urgent-not-important", context: ["Di chuyển"], estimatedTime: 15 },
  { id: "mock-task-4", title: "Nộp bài tập lập trình", categoryId: "mock-4", dueDate: "12 Th3", priority: "Cao", completed: true, color: "purple", description: "Bài tập về React và TypeScript", eisenhowerMatrix: "urgent-important", context: ["Tại máy tính"], estimatedTime: 240 },
  { id: "mock-task-5", title: "Mua quà sinh nhật", categoryId: "mock-5", dueDate: "20 Th3", priority: "Trung bình", completed: false, color: "rose", description: "Sinh nhật mẹ", eisenhowerMatrix: "not-urgent-not-important", context: ["Di chuyển"], estimatedTime: 60 },
  { id: "mock-task-6", title: "Thanh toán hóa đơn điện", categoryId: "mock-6", dueDate: "16 Th3", priority: "Cao", completed: false, color: "amber", description: "Hạn cuối ngày 16", eisenhowerMatrix: "urgent-not-important", context: ["Tại máy tính"], estimatedTime: 10 },
  { id: "mock-task-7", title: "Đọc sách kỹ năng mềm", categoryId: "mock-4", dueDate: "25 Th3", priority: "Thấp", completed: false, color: "purple", description: "Đọc 50 trang", eisenhowerMatrix: "not-urgent-important", context: ["Tập trung sâu"], estimatedTime: 90 },
  { id: "mock-task-8", title: "Gửi email khách hàng", categoryId: "mock-1", dueDate: "13 Th3", priority: "Trung bình", completed: true, color: "indigo", description: "Gửi báo giá dự án", eisenhowerMatrix: "urgent-important", context: ["Tại máy tính"], estimatedTime: 30 },
  { id: "mock-task-9", title: "Lên dàn bài thuyết trình", categoryId: "mock-2", dueDate: "10 Th3", priority: "Cao", completed: false, color: "orange", description: "Deadline bị lỡ 2 ngày", eisenhowerMatrix: "urgent-important", context: ["Tại máy tính"], estimatedTime: 120 },
  { id: "mock-task-10", title: "Gia hạn dịch vụ tên miền", categoryId: "mock-1", dueDate: "05 Th3", priority: "Cao", completed: false, color: "rose", description: "Bị khóa dịch vụ", eisenhowerMatrix: "urgent-important", context: ["Tại máy tính"], estimatedTime: 15 },
  { id: "mock-task-11", title: "Sắp xếp lại tủ sách", categoryId: "mock-5", dueDate: "01 Th3", priority: "Thấp", completed: false, color: "teal", description: "Mục tiêu bị bỏ ngỏ quá lâu", eisenhowerMatrix: "not-urgent-not-important", context: ["Nhà"], estimatedTime: 60 }
];
