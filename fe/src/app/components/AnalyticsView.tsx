              ...
              <div className="bg-slate-900 border border-indigo-500/35 rounded-3xl p-8 max-w-sm w-full text-center space-y-6 shadow-2xl relative overflow-hidden backdrop-blur-xl text-slate-100">
                ...
                <div className="space-y-2">
                  <h3 className="text-lg font-bold tracking-tight text-white" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    {language === "vi" ? "Mở Khóa Biểu Đồ & AI Phân Tích" : "Unlock Charts & AI Analytics"}
                  </h3>
                  <p className="text-slate-400 text-xs leading-relaxed max-w-xs mx-auto font-medium">
                    {language === "vi"
                      ? "Phân tích tiến độ chi tiết, thống kê năng lượng tuần và nhận gợi ý thông minh từ trợ lý AI chỉ dành riêng cho thành viên Premium."
                      : "Detailed progress analysis, weekly energy stats, and smart suggestions from AI are exclusive to Premium members."}
                  </p>
                </div>

                <button
                  onClick={() => navigate("/pricing")}
                  className="w-full py-3.5 px-4 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white rounded-xl text-xs font-bold transition-all shadow-lg shadow-indigo-500/25 flex items-center justify-center gap-2 cursor-pointer border border-transparent"
                >
                  <span>{language === "vi" ? "Nâng cấp Premium để Mở Khóa" : "Upgrade to Premium to Unlock"}</span>
                  <ArrowRight size={14} />
                </button>
              </div>
            </div>
